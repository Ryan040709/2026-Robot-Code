...
public class Right_Trench_Manual extends Command {
  ...
  public Right_Trench_Manual(ShooterSubsystem shooterSubsystem, CommandSwerveDrivetrain drivetrain, TurretSubsystem turretSubsystem) {
