...
public final class Constants {
  ...
  public static final class ThroughBumperIntakeSubsystem {
    ...
    public static double ThroughBumperIntake_PeakForwardDutyCycle = 0;
    public static double ThroughBumperIntake_PeakReverseDutyCycle = 0;
    ...
    public static double ThroughBumperIntake_SupplyCurrentLimit = 0;
    ...
    // Voltage
    public static double ThroughBumperIntake_PeakForwardVoltage = 0;
    public static double ThroughBumperIntake_PeakReverseVoltage = 0;
    // Differential Constants
